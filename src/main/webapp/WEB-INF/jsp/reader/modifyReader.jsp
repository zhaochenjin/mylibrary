...
<form class="layui-form" action="<%=basePath%>library/submitAddReader.action" method="post" id="addbook" lay-filter="example">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="reader_id"  disabled="disabled" value="${readerinfo.reader_id}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea style="width:600px; height:150px" placeholder="请输入地址" name="address"  lay-verify="required"  class="layui-textarea">${readerinfo.address}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
