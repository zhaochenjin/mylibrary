...
<script>
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function () {
        ...
        table.render({
            elem: '#demo'
            , height: 550
            , url: '<%=basePath%>library/listRecommendationBook.action' //数据接口
            , title: '图书表'
            , page: true
            , limit: 5
            , limits: [5, 10, 15, 20]
            , cols: [[ //表头
                ...
                , {field: 'book_id', title: '图书编号', width: 150, sort: true}
                , {field: 'name', title: '书名', width: 200}
                ,{title: '图书类别', width:200, templet:function(d){return d.category.cname;}}
